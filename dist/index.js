...
const Chime = __webpack_require__(558);
...
const chime_1 = __importDefault(__webpack_require__(91));
function run() {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            // send the request
            const msg = yield chime_1.default.sendMessage(message, webhook, {
                markdown: !noMarkdown
            });
            core.setOutput('message-id', msg === null || msg === void 0 ? void 0 : msg.messageId);
        }
        catch (err) {
